...
public class CustomizedPresenter extends BasePresenter<CustomizedPresenter.MyView, CustomizedPresenter.MyProxy> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.CUSTOMIZED)
    interface MyProxy extends ProxyPlace<CustomizedPresenter> {
    }
    ...
    protected void onReveal() {
        ...
        setHeaderTitle("Customized", "Using the DataTable scaffoding features, you can now easily design your datatable look and feel.", "customized");
    }
}
